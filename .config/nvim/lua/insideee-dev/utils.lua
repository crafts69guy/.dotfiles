...
-- Copies the relative path of the current file to the clipboard
function M.copy_to_clipboard(has_current_line)
	-- get current path based on current buffer
	...
	-- set clipboard to path
	vim.fn.setreg("+", relative_path)

	local message = "Copied relative path: "
	if has_current_line then
		message = "Copied relative path and line number: "
	end
