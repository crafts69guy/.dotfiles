return {
...

	{
		...
		opts = function(_, opts)
			-- Override neo-tree defaults to support transparent background
		...
		config = function(_, opts)
			...
			-- Apply transparent background to neo-tree to match solarized-osaka transparent theme
			local function set_neotree_transparent()
			...
			-- Apply highlights when neo-tree opens and when colorscheme changes
			vim.api.nvim_create_autocmd("FileType", {
				pattern = "neo-tree",
				callback = set_neotree_transparent,
			})
